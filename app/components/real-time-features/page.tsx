...
import { FiArrowLeft, FiCheck, FiRefreshCw, FiMessageCircle, FiBell, FiEdit } from 'react-icons/fi';

export default function RealTimeFeaturesModule() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
        ...
        >
          <div className="flex flex-col md:flex-row md:items-start gap-6 mb-6">
            <div className="bg-zinc-900/50 p-4 md:p-6 border border-zinc-800">
              <FiRefreshCw className="text-3xl md:text-4xl text-white" />
            </div>
            <div className="flex-1">
              ...
              <p className="text-zinc-400 max-w-2xl">
                Enable live, dynamic user experiences with real-time features.
              </p>
            </div>
          ...
          >
            <section>
              ...
              <p className="text-zinc-400 text-sm mb-6">
                Enable live, dynamic user experiences with features like live chat, notifications, and collaborative editing. Built for speed and scalability.
              </p>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-500 text-xs">In-app messaging and chat functionality.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FiBell className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm">Live Notifications</h3>
                    <p className="text-zinc-500 text-xs">Push instant updates and alerts to users.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FiEdit className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm">Collaborative Editing</h3>
                    <p className="text-zinc-500 text-xs">Allow multiple users to edit the same data.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                {[
                  'Live Notifications', 'Real-time Chat', 'Collab Editing', 'Live Dashboards',
                  'Activity Feeds', 'Presence', 'Typing Indicators', 'Read Receipts'
                ].map((feature) => (
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Socket.IO', 'WebSockets', 'Redis', 'Node.js', 'Next.js'].map((tech) => (
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-zinc-400">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Setup of real-time communication server</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-zinc-600">02.</span>
                      <span>Backend APIs for real-time data exchange</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-zinc-600">03.</span>
                      <span>Frontend components for live updates</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-zinc-600">04.</span>
                      <span>Scalability planning and load testing</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500">Base Real-time Setup</span>
                  <span className="font-bold text-white">£500</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500">Chat / Notifications</span>
                  <span className="font-bold text-white">£200</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500">Collab / Dashboards</span>
                  <span className="font-bold text-white">£200</span>
                </div>
              ...
              <div className="space-y-4 text-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">Infra setup & basic features</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-zinc-900 border border-zinc-800 flex items-center justify-center text-xs font-bold text-zinc-500">
