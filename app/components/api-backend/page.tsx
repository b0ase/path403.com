...
import { FiArrowLeft, FiCheck, FiServer, FiShield, FiDatabase, FiCode } from 'react-icons/fi';

export default function APIBackendModule() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
        ...
        >
          <div className="flex flex-col md:flex-row md:items-start gap-6 mb-6">
            <div className="bg-zinc-900/50 p-4 md:p-6 border border-zinc-800">
              <FiServer className="text-3xl md:text-4xl text-white" />
            </div>
            <div className="flex-1">
              <p className="text-xs text-zinc-500 font-mono uppercase tracking-widest mb-2">Backend</p>
              <h1 className="text-3xl md:text-5xl font-bold uppercase tracking-tighter mb-4">
                API Backend
              </h1>
              <p className="text-zinc-400 max-w-2xl">
                Scalable, secure API with authentication, database integration, and documentation.
              </p>
            </div>
          ...
          >
            <div>
              ...
              <p className="text-zinc-400 text-sm mb-6">
                Build your application on a solid foundation, perfect for web, mobile, and third-party integrations.
              </p>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <FiShield className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm mb-1">Secure Authentication</h3>
                    <p className="text-zinc-500 text-xs">JWTs, role-based access, and session management.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FiDatabase className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm mb-1">Database Integration</h3>
                    <p className="text-zinc-500 text-xs">Optimized queries with ORM, migrations, and pooling.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FiCode className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm mb-1">Clean Architecture</h3>
                    <p className="text-zinc-500 text-xs">Well-structured codebase using MVC and DI patterns.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['Node.js', 'Express/Fastify', 'PostgreSQL', 'Redis', 'Docker', 'Swagger'].map((tech) => (
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500 text-sm">Base API Setup</span>
                  <span className="font-bold text-white">£600</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500 text-sm">Database & ORM</span>
                  <span className="font-bold text-white">£200</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500 text-sm">Auth & RBAC</span>
                  <span className="font-bold text-white">£200</span>
                </div>
                <div className="flex justify-between items-center pt-2">
                  <span className="font-bold text-white">Total Range</span>
                  <span className="font-bold text-emerald-500">£600-1000</span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">Core setup, auth & database</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-emerald-500 mt-2"></div>
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">Endpoint dev, docs & testing</div>
                  </div>
                </div>
              </div>
            </div>
