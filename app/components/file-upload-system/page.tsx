...
import { FiArrowLeft, FiCheck, FiUploadCloud, FiCloud, FiLock, FiGlobe } from 'react-icons/fi';

export default function FileUploadSystemModule() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
        ...
        >
          <div className="flex flex-col md:flex-row md:items-start gap-6 mb-6">
            <div className="bg-zinc-900/50 p-4 md:p-6 border border-zinc-800">
              <FiUploadCloud className="text-3xl md:text-4xl text-white" />
            </div>
            <div className="flex-1">
              ...
              <p className="text-zinc-400 max-w-2xl">
                A robust and secure system for handling file uploads, storage, and delivery.
              </p>
            </div>
          ...
          >
            <section>
              ...
              <p className="text-zinc-400 text-sm mb-6">
                A robust and secure system for handling file uploads, storage, and delivery, integrated with modern cloud services for scalability.
              </p>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <FiCloud className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm">Cloud Storage</h3>
                    <p className="text-zinc-500 text-xs">Seamless integration with AWS S3, Cloudflare R2, etc.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FiLock className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm">Secure File Handling</h3>
                    <p className="text-zinc-500 text-xs">End-to-end encryption and secure transfer protocols.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FiGlobe className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm">CDN Delivery</h3>
                    <p className="text-zinc-500 text-xs">Fast content delivery network to serve files quickly.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                {[
                  'Secure Handling', 'Cloud Storage', 'Chunked Uploads', 'Image Optimize',
                  'CDN Delivery', 'Usage Analytics', 'Multi-file Upload', 'Drag & Drop'
                ].map((feature) => (
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['AWS S3', 'Cloudflare R2', 'Node.js', 'Next.js', 'Multer'].map((tech) => (
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-zinc-400">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Setup of cloud storage buckets</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-zinc-600">02.</span>
                      <span>Backend API endpoints for uploads</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-zinc-600">03.</span>
                      <span>Frontend components for file selection</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-zinc-600">04.</span>
                      <span>Implementation of CDN delivery</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500">Base Upload System</span>
                  <span className="font-bold text-white">£500</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500">Cloud Storage Setup</span>
                  <span className="font-bold text-white">£150</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500">Image Optimize/CDN</span>
              ...
              <div className="space-y-4 text-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">Backend & storage integration</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-zinc-900 border border-zinc-800 flex items-center justify-center text-xs font-bold text-zinc-500">
                  ...
                  <div>
                    <div className="font-bold text-white">Week 2</div>
                    <div className="text-xs text-zinc-500">Frontend UI & advanced features</div>
                  </div>
                </div>
              </div>
            </section>
