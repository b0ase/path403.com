...
import { FiArrowLeft, FiCheck, FiBell, FiMail, FiMessageSquare, FiSmartphone } from 'react-icons/fi';

export default function NotificationSystemModule() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
        ...
        >
          <div className="flex flex-col md:flex-row md:items-start gap-6 mb-6">
            <div className="bg-zinc-900/50 p-4 md:p-6 border border-zinc-800">
              <FiBell className="text-3xl md:text-4xl text-white" />
            </div>
            <div className="flex-1">
              ...
              <p className="text-zinc-400 max-w-2xl">
                Engage users with timely notifications across email, SMS, and push channels.
              </p>
            </div>
          ...
          >
            <section>
              ...
              <p className="text-zinc-400 text-sm mb-6">
                A robust infrastructure for sending targeted notifications to keep your users informed, engaged, and retained.
              </p>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-500 text-xs">Integrate with services like SendGrid or Mailgun.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FiMessageSquare className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm">SMS Alerts</h3>
                    <p className="text-zinc-500 text-xs">Send critical alerts using Twilio or similar services.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-500 text-xs">Engage users with native push notifications via Firebase.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                {[
                  'Multi-channel Delivery', 'User Preferences', 'Custom Templates',
                  'Scheduled & Triggered', 'Audience Segmentation', 'Delivery Tracking',
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Node.js', 'Firebase', 'Twilio API', 'SendGrid API', 'Redis', 'PostgreSQL'].map((tech) => (
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-zinc-400">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Configuration of notification service providers</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-zinc-600">02.</span>
                      <span>API for triggering notifications</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-zinc-600">03.</span>
                      <span>Frontend for managing user preferences</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-zinc-600">04.</span>
                      <span>Database schema for history and settings</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500">Core Setup (1 channel)</span>
                  <span className="font-bold text-white">£600</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500">Additional Channel (ea)</span>
                  <span className="font-bold text-white">£150</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500">Analytics Dashboard</span>
              ...
              <div className="space-y-4 text-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">Backend setup and provider integration</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-zinc-900 border border-zinc-800 flex items-center justify-center text-xs font-bold text-zinc-500">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">Template design and preference UI</div>
                  </div>
                </div>
              </div>
            </section>
