...
import { FiArrowLeft, FiCheck, FiMessageSquare, FiGlobe, FiTrendingUp, FiCpu } from 'react-icons/fi';
        ...
        >
          <div className="flex flex-col md:flex-row md:items-start gap-6 mb-6">
            <div className="bg-zinc-900/50 p-4 md:p-6 border border-zinc-800">
              <FiMessageSquare className="text-3xl md:text-4xl text-white" />
            </div>
            <div className="flex-1">
              <p className="text-xs text-zinc-500 font-mono uppercase tracking-widest mb-2">AI Integration</p>
              <h1 className="text-3xl md:text-5xl font-bold uppercase tracking-tighter mb-4">
                AI Chatbot
              </h1>
              <p className="text-zinc-400 max-w-2xl">
                Transform customer service with an intelligent chatbot powered by cutting-edge AI.
              </p>
            </div>
          ...
          >
            <div>
              ...
              <p className="text-zinc-400 text-sm mb-6">
                A sophisticated conversational AI that handles inquiries, provides support, and engages users 24/7.
              </p>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <FiCpu className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm mb-1">Intelligent Responses</h3>
                    <p className="text-zinc-500 text-xs">Understands context and provides relevant, helpful answers.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FiGlobe className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm mb-1">Multi-Language Support</h3>
                    <p className="text-zinc-500 text-xs">Communicate with customers in their preferred language.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FiTrendingUp className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm mb-1">Conversation Analytics</h3>
                    <p className="text-zinc-500 text-xs">Track performance, common queries, and satisfaction.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['OpenAI GPT', 'LangChain', 'Vector DB', 'Node.js', 'WebSocket', 'Redis'].map((tech) => (
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500 text-sm">Base Setup</span>
                  <span className="font-bold text-white">£700</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500 text-sm">Custom Training</span>
                  <span className="font-bold text-white">£200</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500 text-sm">Multi-language</span>
                ...
                <div className="flex justify-between items-center pt-2">
                  ...
                  <span className="font-bold text-emerald-500">£700-1200</span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">Setup & training data prep</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-emerald-500 mt-2"></div>
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">AI model training & optimization</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-emerald-500 mt-2"></div>
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">Integration, testing & deployment</div>
                  </div>
                </div>
              </div>
            </div>
