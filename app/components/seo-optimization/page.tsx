...
import { FiArrowLeft, FiCheck, FiSearch, FiTrendingUp, FiGlobe, FiGrid } from 'react-icons/fi';

export default function SeoOptimizationModule() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
          ...
          <div className="flex flex-col md:flex-row md:items-start gap-6 mb-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-zinc-400 max-w-2xl">
                Complete SEO tools and features to improve your search engine ranking.
              </p>
            </div>
          ...
          >
            <section>
              ...
              <p className="text-zinc-400 text-sm mb-6">
                A comprehensive suite of tools to improve your website's search ranking, attract more organic traffic, and increase visibility.
              </p>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <FiTrendingUp className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm">Keyword Research</h3>
                    <p className="text-zinc-500 text-xs">Identify high-value keywords and analyze competitor strategies.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FiGlobe className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm">On-Page SEO</h3>
                    <p className="text-zinc-500 text-xs">Optimize meta titles, descriptions, and content.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FiGrid className="text-emerald-500 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-bold text-white text-sm">Technical SEO</h3>
                    <p className="text-zinc-500 text-xs">Address crawlability, site speed, and mobile-friendliness.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                {[
                  'Keyword Research', 'On-Page SEO', 'Technical SEO', 'Schema Markup',
                  'Content Optimization', 'Backlink Analysis', 'Competitor Analysis', 'Analytics'
                ].map((feature) => (
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Next.js', 'Google Analytics', 'Search Console', 'Ahrefs', 'Semrush'].map((tech) => (
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-zinc-400">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Initial SEO audit and strategy</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-zinc-600">02.</span>
                      <span>Implementation of on-page & technical SEO</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-zinc-600">03.</span>
                      <span>Integration with analytics tools</span>
                    </li>
                    <li className="flex items-start gap-2">
            ...
            <section>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500">Basic SEO Audit</span>
                  <span className="font-bold text-white">£300</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500">On-Page Optimization</span>
                  <span className="font-bold text-white">£150</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-900">
                  <span className="text-zinc-500">Technical SEO</span>
                  <span className="font-bold text-white">£150</span>
                </div>
              ...
              <div className="space-y-4 text-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">Initial audit & strategy</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-zinc-900 border border-zinc-800 flex items-center justify-center text-xs font-bold text-zinc-500">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-zinc-500">Implementation & monitoring</div>
                  </div>
                </div>
              </div>
            </section>
