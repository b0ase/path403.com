...
__export(server_exports, {
  ...
  createSessionCookies: () => createSessionCookies,
  generateDisplayName: () => generateDisplayName,
  getAddressExplorerUrl: () => getAddressExplorerUrl,
  getChainForProvider: () => getChainForProvider,
  getExplorerUrl: () => getExplorerUrl,
  isValidBsvAddress: () => isValidBsvAddress,
  isValidEthereumAddress: () => isValidEthereumAddress,
  isValidHandCashHandle: () => isValidHandCashHandle,
  isValidSolanaAddress: () => isValidSolanaAddress,
  normalizeAddress: () => normalizeAddress,
  parseWalletSession: () => parseWalletSession,
