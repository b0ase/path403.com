...
function FlowCanvas({
  ...
  const handleNodeMouseDown = (0, import_react.useCallback)(
    (e, nodeId) => {
      e.stopPropagation();
      const rect = canvasRef.current?.getBoundingClientRect();
      if (!rect) return;
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              state.showGrid && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { className: "absolute inset-0 w-full h-full pointer-events-none opacity-20", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { width: "100%", height: "100%", fill: "url(#flow-canvas-grid)" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { className: "absolute inset-0 w-full h-full pointer-events-none", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "marker",
                  {
                    ...
                    refY: "3",
                    orient: "auto",
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("polygon", { points: "0 0, 8 3, 0 6", fill: "currentColor", className: "text-white" })
                  }
                ) }),
                state.connections.map((connection) => {
                  ...
                  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
                    ...
                    connection.label && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      "text",
                      {
                        x: (fromX + toX) / 2,
                        y: (fromY + toY) / 2 - 10,
                    ...
                    connection.amount !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      "text",
                      {
                        x: (fromX + toX) / 2,
                        y: (fromY + toY) / 2 + 5,
                ...
                state.connectingFrom && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "line",
                  {
              ...
              state.nodes.map((node) => {
                ...
                return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between p-3", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center space-x-2", children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `w-2 h-2 rounded-full ${getStatusColor(node.status)}` }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "div",
                            {
                              className: "w-6 h-6 rounded-lg flex items-center justify-center",
                              style: { backgroundColor: `${nodeColor}20` },
                              children: nodeType?.icon ? nodeType.icon : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: nodeColor }, className: "text-xs font-bold", children: node.type[0].toUpperCase() })
                            }
                          )
                        ] }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "px-3 pb-3 space-y-1", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "text-white text-sm font-medium truncate", children: node.name }),
                        node.description && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "text-gray-400 text-xs truncate", children: node.description }),
                        node.data?.amount != null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "text-yellow-400 text-sm font-medium", children: [
                          "$",
                          Number(node.data.amount).toLocaleString()
                        ] }),
                        node.data?.deadline != null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "text-gray-400 text-xs", children: [
                          "Due: ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "absolute bottom-4 right-4 bg-black/50 backdrop-blur-sm rounded-lg px-3 py-2 text-xs text-gray-300 pointer-events-none", children: [
          state.nodes.length,
          " nodes \u2022 ",
...
function useFlowCanvas(options = {}) {
  ...
  const updateState = (0, import_react2.useCallback)(
    (updater) => {
      setState((prev) => {
  ...
  const addNode = (0, import_react2.useCallback)(
    (type, position, data) => {
      const id = generateId();
  ...
  const updateNode = (0, import_react2.useCallback)(
    (id, updates) => {
      updateState((prev) => ({
        ...prev,
  ...
  const deleteNodes = (0, import_react2.useCallback)(
    (ids) => {
      updateState((prev) => ({
        ...prev,
  ...
  const addConnection = (0, import_react2.useCallback)(
  ...
  const deleteConnection = (0, import_react2.useCallback)(
    (id) => {
      updateState((prev) => ({
        ...prev,
  ...
  const selectNodes = (0, import_react2.useCallback)(
    (ids) => {
      updateState((prev) => ({
        ...prev,
  ...
  const setTool = (0, import_react2.useCallback)(
    (tool) => {
      updateState((prev) => ({
        ...prev,
        tool,
  ...
  const setScale = (0, import_react2.useCallback)(
    (scale) => {
      updateState((prev) => ({
        ...prev,
  ...
  const toggleGrid = (0, import_react2.useCallback)(() => {
    updateState((prev) => ({ ...prev, showGrid: !prev.showGrid }));
  }, [updateState]);
  const toggleGridSnap = (0, import_react2.useCallback)(() => {
    updateState((prev) => ({ ...prev, gridSnap: !prev.gridSnap }));
  }, [updateState]);
  const toJSON = (0, import_react2.useCallback)(() => {
    return JSON.stringify({
      nodes: state.nodes,
      connections: state.connections
    });
  }, [state.nodes, state.connections]);
  const fromJSON = (0, import_react2.useCallback)(
    (json) => {
      try {
