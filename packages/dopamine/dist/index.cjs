...
__export(index_exports, {
  DEFAULT_PARTICLE_CONFIG: () => DEFAULT_PARTICLE_CONFIG,
  DEFAULT_PREFERENCES: () => DEFAULT_PREFERENCES,
  DopamineManager: () => DopamineManager,
  EFFECT_PRESETS: () => EFFECT_PRESETS,
  createConfettiConfig: () => createConfettiConfig,
  createDopamineManager: () => createDopamineManager,
  generateParticles: () => generateParticles,
  getDefaultSoundUrls: () => getDefaultSoundUrls,
  getRandomColor: () => getRandomColor,
  scaleIntensity: () => scaleIntensity,
  shouldTriggerForAmount: () => shouldTriggerForAmount
});
